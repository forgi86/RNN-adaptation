...
if __name__ == "__main__":
    ...
    # [data_train, response_train, data_transf, response_transf,
    #  data_transf_test, response_transf_test] = RLC_sim()
    ...
    model = models.LSTMWrapper(lstm, n_in, n_out,
                               seq_len, n_hidden, on_batch=False).double()  # [bsize, n_in * seq_len] -> [bsize, n_out * seq_len]
    print([name for name, p in model.state_dict().items()])
